...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Google Sheets 언어 시트를 프론트엔드용 JSON으로 변환합니다.",
    )
    ...
    parser.add_argument("--output-dir", default="public/data", help="출력 디렉터리")
    parser.add_argument("--language-code", default="ja", help="언어 코드")
    parser.add_argument("--language-label", default="일본어", help="언어 이름")
